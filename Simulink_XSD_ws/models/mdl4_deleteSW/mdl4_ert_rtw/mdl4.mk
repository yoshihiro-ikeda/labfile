###########################################################################
## Makefile generated for Simulink model 'mdl4'. 
## 
## Makefile     : mdl4.mk
## Generated on : Wed Apr 13 00:45:55 2016
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mdl4
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = mdl4_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mdl4
...
INCLUDES_BUILDINFO = -I$(START_DIR)/mdl4_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=mdl4 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/mdl4_ert_rtw/mdl4.c $(START_DIR)/mdl4_ert_rtw/rt_zcfcn.c

MAIN_SRC = $(START_DIR)/mdl4_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/mdl4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mdl4_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
