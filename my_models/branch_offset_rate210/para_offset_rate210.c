...
#include "para_offset_rate210_res.c"
...
/* From: offset_rate210_MathFunction10
   To: offset_rate210_S_Function4 */
typedef struct {
  int flag__0013_0026;
  real_T offset_rate210_MathFunction10_1;
} TYPE_0013_0026;
TYPE_0013_0026 CH_0013_0026;

/* From: offset_rate210_MathFunction2
   To: offset_rate210_S_Function */
typedef struct {
  int flag__0014_0022;
  real_T offset_rate210_MathFunction2_1;
} TYPE_0014_0022;
TYPE_0014_0022 CH_0014_0022;
...
/* From: offset_rate210_MathFunction4
   To: offset_rate210_S_Function1 */
typedef struct {
  int flag__0016_0023;
  real_T offset_rate210_MathFunction4_1;
} TYPE_0016_0023;
TYPE_0016_0023 CH_0016_0023;
...
/* From: offset_rate210_MathFunction6
   To: offset_rate210_S_Function2 */
typedef struct {
  int flag__0018_0024;
  real_T offset_rate210_MathFunction6_1;
} TYPE_0018_0024;
TYPE_0018_0024 CH_0018_0024;
...
/* From: offset_rate210_MathFunction8
   To: offset_rate210_S_Function3 */
typedef struct {
  int flag__0020_0025;
  real_T offset_rate210_MathFunction8_1;
} TYPE_0020_0025;
TYPE_0020_0025 CH_0020_0025;
...
/* From: offset_rate210_S_Function
   To: offset_rate210_Gain1 */
typedef struct {
  int flag__0022_0002;
  real_T offset_rate210_S_Function_1;
} TYPE_0022_0002;
TYPE_0022_0002 CH_0022_0002;

/* From: offset_rate210_S_Function1
   To: offset_rate210_Gain3 */
typedef struct {
  int flag__0023_0005;
  real_T offset_rate210_S_Function1_1;
} TYPE_0023_0005;
TYPE_0023_0005 CH_0023_0005;

/* From: offset_rate210_S_Function2
   To: offset_rate210_Gain5 */
typedef struct {
  int flag__0024_0007;
  real_T offset_rate210_S_Function2_1;
} TYPE_0024_0007;
TYPE_0024_0007 CH_0024_0007;

/* From: offset_rate210_S_Function3
   To: offset_rate210_Gain7 */
typedef struct {
  int flag__0025_0009;
  real_T offset_rate210_S_Function3_1;
} TYPE_0025_0009;
TYPE_0025_0009 CH_0025_0009;

/* From: offset_rate210_S_Function4
   To: offset_rate210_Gain9 */
typedef struct {
  int flag__0026_0011;
  real_T offset_rate210_S_Function4_1;
} TYPE_0026_0011;
TYPE_0026_0011 CH_0026_0011;
...
{  /* omit input channel bit vector */
  ...
  struct {
    ...
    real_T UnitDelay2_DSTATE; /* task_0027 */
  } offset_rate210_DW;
  ...
  /* Block: offset_rate210_S_Function */
  real_T offset_rate210_MathFunction2_1;
  ...
  /* Block: offset_rate210_S_Function1 */
  real_T offset_rate210_MathFunction4_1;
  ...
  /* Block: offset_rate210_S_Function2 */
  real_T offset_rate210_MathFunction6_1;
  ...
  /* Block: offset_rate210_S_Function3 */
  real_T offset_rate210_MathFunction8_1;
  ...
  /* Block: offset_rate210_S_Function4 */
  real_T offset_rate210_MathFunction10_1;
        ...
        {
{
  ...
  if (offset_rate210_M->Timing.TaskCounters.TID[5] == 0) {
    ...
    while (1) {
      ...
      if (CH_0003_0032.flag__0003_0032 == 0) {
	CH_0003_0032.offset_rate210_Gain10_1 = offset_rate210_Gain10_1;
	CH__SYNCM();
	CH_0003_0032.flag__0003_0032 = 1;
	CH__EVENT(TASK_0003,IN_0032);
    ...
    while (1) {
      ...
      if (CH_0001_0027.flag__0001_0027 == 1) {
	offset_rate210_Gain_1 = CH_0001_0027.offset_rate210_Gain_1;
	CH__SYNCM();
	CH_0001_0027.flag__0001_0027 = 0;
	CH__EVENT(TASK_0027, OUT_0001);
	CH__END_LOG(IN_0027);
	break;
      }
...
{  /* omit input channel bit vector */
  ...
  struct {
    ...
    real_T UnitDelay_DSTATE; /* task_0032 */
  } offset_rate210_DW;
...

{
  ...
  offset_rate210_Gain_1 = offset_rate210_P.Gain_Gain *
    ...
    /* wait output channel */
    while (1) {
      /* skip local output CH_0001_0032: offset_rate210_Sum */

      /* output: offset_rate210_Sqrt1 */
      if (CH_0001_0027.flag__0001_0027 == 0) {
	CH_0001_0027.offset_rate210_Gain_1 = offset_rate210_Gain_1;
	CH__SYNCM();
	CH_0001_0027.flag__0001_0027 = 1;
	CH__EVENT(TASK_0001,IN_0027);
...
loop_Outputs_wrapper(&offset_rate210_Gain_1,
                         &offset_rate210_Gain_1 );
    ...
    {
{
  ...
  offset_rate210_DW.UnitDelay1_DSTATE = offset_rate210_Sum_1;
    ...
    while (1) {
      ...
      if (CH_0003_0032.flag__0003_0032 == 1) {
	offset_rate210_Gain10_1 = CH_0003_0032.offset_rate210_Gain10_1;
	CH__SYNCM();
	CH_0003_0032.flag__0003_0032 = 0;
	CH__EVENT(TASK_0032, OUT_0003);
	CH__END_LOG(IN_0032);
	break;
      }

      CH__CORE_THREAD_SCHED(IN_0032,NULL,1);

      CH__MEM_BARRIER();
    }

#ifdef TASK_UPDATE_IN_0032_COMPLETED
    TASK_UPDATE_IN_0032_COMPLETED();
#endif
...
#ifdef TASK_UPDATE_0032_COMPLETED
    TASK_UPDATE_0032_COMPLETED();
#endif
  }
}
